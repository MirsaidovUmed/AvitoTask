...
func (b *bidRepo) ChangeBidStatus(bid *models.Bid) (*models.Bid, error) {
	...
	query := "UPDATE bids SET status = $1, version = $2 WHERE id = $3 AND author_id = $4 RETURNING id, name, status, author_type, author_id, version, created_at"
...
func (b *bidRepo) SendDesicionByBid(bid *models.Bid) (*models.Bid, error) {
	...
	query := "UPDATE bids SET decision = $1, version = $2 WHERE id = $3 AND author_id = $4 RETURNING id, name, status, author_type, author_id, version, decision, created_at"
